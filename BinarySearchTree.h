...
private:
        ...
        // Private methods added to help remove method
        // These are helper and don't impact the user implementation of the 
        // BinarySearchTree class
        void remove_leaf(Node* node, Node* parent);
        void remove_right_child(Node* node, Node* parent);
        void remove_left_child(Node* node, Node* parent);
        void remove_both_child(Node* node, Node* parent);
